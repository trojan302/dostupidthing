...
<head>
	...
	<link rel="icon" type="image/png" href="./libs/img/icon.png">
</head>
<body>

	<div class="betta-container betta-padding-jumbo betta-grey betta-center">
		<h1><i class="fa fa-code"></i> Hai Betta Newbie...!</h1>
		<?php // Quotes Data
		$dq      = $db->query("SELECT * FROM quotes ORDER BY RAND()");
		$quotes  = $dq->fetch_assoc(); ?>
		<p class="typed"><?= $quotes['quote']; ?><span class="cursor">|</span></p>
	</div>
	<ul class="betta-navbar betta-white betta-wide betta-padding-8 betta-card-2">
		<li>
